...
def RPCHelp_cpp(w):
    ...
    for mode in modes:
        ...
        if mode != 'EModeType::MODE_CONSOLE':
            ...
            # options is not empty, output options. It's hashahead-cli -help
...
def generate_protocol_h():
    with open(protocol_h, 'w') as w:
        ...
        # file top
        w.write('''
#ifndef HASHAHEAD_RPC_AUTO_PROTOCOL_H
#define HASHAHEAD_RPC_AUTO_PROTOCOL_H
...
#endif  // HASHAHEAD_RPC_AUTO_PROTOCOL_H
''')
...
def generate_config_h():
    with open(config_h, 'w') as w:
        ...
        # file top
        w.write('''
#ifndef HASHAHEAD_MODE_AUTO_CONFIG_H
#define HASHAHEAD_MODE_AUTO_CONFIG_H
...
#endif  // HASHAHEAD_MODE_AUTO_CONFIG_H
''')
