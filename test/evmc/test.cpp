...
{
    using namespace std;
    const std::string wasmf = "/home/shang/mam/hashahead/test/evmc/test.wasm";
...
{
    using namespace std;
    const std::string wasmf = "/home/shang/mam/hashahead/test/evmc/test_.wasm";
