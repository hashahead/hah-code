...
#define MAX_SNAPSHOT_STATE_HEIGHT GET_PARAM(10, 10)
...
#define MORTGAGE_DECAY_CYCLE_MAINNET (DAY_HEIGHT_MAINNET * 180)
...
#define MIN_CREATE_FORK_INTERVAL_HEIGHT GET_PARAM(6, 0)
#define MAX_JOINT_FORK_INTERVAL_HEIGHT GET_PARAM(DAY_HEIGHT_MAINNET, 0x7FFFFFFF)

static const bool fCreateUserForkEnable = true;
