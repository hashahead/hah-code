...
struct VMSchedule
{
    ...
    static constexpr int64_t tstoreGas = 100;
};
...
public:
    ...
    VM() = default;
    VM(evmc_operation_trace_fn trace_fn, void* trace_user) : m_onOp(trace_fn), m_pOpUser(trace_user) {}
...
private:
    ...
    evmc_operation_trace_fn m_onOp = nullptr;
    void* m_pOpUser = nullptr;
