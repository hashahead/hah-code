...
enum class Instruction : uint8_t
{
    ...
    BLOBHASH,         ///< get block's blobhash
    BLOBBASEFEE,      ///< get block's blobfee
    ...
    TLOAD,       ///< Load from transient (temporary) storage
    TSTORE,      ///< Store to transient storage
    MCOPY,       ///< Copy memory from one location to another within the EVM’s memory space.
