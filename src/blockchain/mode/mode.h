...
#ifndef HASHAHEAD_MODE_MODE_H
#define HASHAHEAD_MODE_MODE_H
        ...
        static std::map<EModeType, std::vector<EModuleType>> mapping = {
            { EModeType::MODE_SERVER,
              { EModuleType::LOCK,
                ...
                EModuleType::PRUNEDB,
                EModuleType::CHAINSNAPSHOT,
                EModuleType::NATPORTMAPPING } },
