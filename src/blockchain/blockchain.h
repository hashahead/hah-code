...
#ifndef HASHAHEAD_BLOCKCHAIN_H
#define HASHAHEAD_BLOCKCHAIN_H
...
public:
    ...
    Errno VerifyPoaBlock(const CBlock& block, bool& fLongChain) override;
    ...
    bool VerifyAddressPledgeVote(const CDestination& dest, const uint256& hashPrevBlock) override;
