...
#ifndef HASHAHEAD_SERVICE_H
#define HASHAHEAD_SERVICE_H
...
public:
    ...
    bool GetEthTransactionByIndex(const uint256& hashBlock, const uint64 nTxIndex, CTransaction& tx, uint64& nBlockNumber) override;
