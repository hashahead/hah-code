...
public:
    ...
    BlockIndexPtr GetOriginBlockIndex(const BlockIndexPtr pIndex);
    BlockIndexPtr GetPrevBlockIndex(const BlockIndexPtr pIndex);
    BlockIndexPtr GetNextBlockIndex(const BlockIndexPtr pIndex);
    ...
    bool RetrieveDelegateEnrollStatus(const uint256& hashBlock, std::map<CDestination, std::pair<uint32, uint64>>& mapDelegateEnrollStatus);
    bool RetrieveDelegateRewardApy(const uint256& hashBlock, std::map<CDestination, std::pair<uint256, double>>& mapDelegateRewardApy);
    ...
    SHP_BLOCK_STATE CreateBlockStateRoot(const uint256& hashFork, const CForkContext& ctxFork, const CBlock& block, const uint256& hashPrevStateRoot, const uint32 nPrevBlockTime, uint256& hashStateRoot, uint256& hashReceiptRoot,
    ...
    bool ReUpdateBlockTraceData(const uint256& hashFork, const uint256& hashBlock);
